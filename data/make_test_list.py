...
fire_data=glob.glob("/nfs/project/surveillance/smoke_fire_detection/test/fire/*")
smoke_data=glob.glob("/nfs/project/surveillance/smoke_fire_detection/test/smoke/*")
normal_data=glob.glob("/nfs/project/surveillance/smoke_fire_detection/test/normal/*")
data_lsit=[]
'''
...
with open('test_list.csv', 'w') as fout:
